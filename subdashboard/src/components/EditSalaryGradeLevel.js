...
const EditGradeLevel = (props) => {
  ...
  useEffect(() => {
    ...
    selectEditRegime(data.regime_code, data.category_code, data.structure_code);
    handleChange(data.maximum_step, 'maximum_step');
    handleChange(data.grade_name, 'name');
    handleChange(data.pensionable, 'pensionable');
    handleChange(data.step_status, 'step_status');
    handleChange(data.grade_level_code, 'grade_level_code');
    handleChange({ id: data.grade_level_digit }, 'grade_level_digit');
  }, []);
    ...
    <div className="w-100 pt-4 edit-card">
      ...
      <Row className="justify-content-md-center align-items-center  h-100">
        <Col md={4} className="edit-container">
          ...
          <p className="text-center">Edit Grade Level</p>
          <Select
          ...
          />
          <Select
            label="Salary Grade Level Digit "
          ...
          <div className="mb-3 mx-3">
            <button
              onClick={async () => {
                let sent = await editGradeLevel();
                if (sent) {
                  setEdit(false);
                  setData({
                    ...data,
                    regime: gradeData.regime.regime_name,
                    category_code: gradeData.category.category_code,
                    salary_structure: gradeData.structure.structure_name,
                  ...
                  setSuccess('Grade updated succesfully');
                }
              }}
