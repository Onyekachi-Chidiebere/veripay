  ...
  return (
    <div className="w-100 pt-4 dashboard-card">
      ...
      <Row className="justify-content-md-center">
        <Col md={5}>
          <Select label="Salary Scale Regime " text="" />
          <Select label="Salary Structure " text="" />
          <Select label="Salary Structure Category " text="" />
          <button className="add-salary-grade-text-btn">
            <svg
              className="me-2"
              width="24"
              height="24"
            ...
            <span className="add-salary-grade-text">
              Create grade name from Salary Structure
            </span>
          </button>
          <div className="mt-3">
