...
// import CollapsinTable from './collapsingTable/CollapsingTable';

const AddSalaryRegime = ({ close, handleUpdate }) => {
  ...
  // return <CollapsinTable />;{ rows, columns }
  return (
    <div className="w-100  edit-card">
      {success && (
        <SweetAlert
          ...
          onConfirm={() => {
            ...
            // if (setup_stage === '2') {
            //   navigate('/dashboard/setup/salary_structure/structure/category');
            // } else {
            //   navigate('/dashboard/setup/salary_structure');
            // }
          }}
          onCancel={() => {
            setSuccess(false);
      ...
      <Row className="justify-content-md-center align-items-center  h-100">
        <Col md={4} className="edit-container">
          ...
          <p class="text-center">Add a Salary Scale Regime</p>
          <Select
            label="Year"
...
export default AddSalaryRegime;
