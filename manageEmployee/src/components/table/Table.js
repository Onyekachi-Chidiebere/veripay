...
const Table = ({
  ...
  return (
    <div className="table-responsive">
        ...
        {(props) => (
          <div className="veripay-table-holder">
            <div className="table-search-download-holder">
              ...
              {search && (
                <button className="btn table-download-holder">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
      ...
      {rows.length !== 0 && (
        <div className="col d-flex w-100 mt-4 justify-content-end table-nav-bottom">
          {prev && (
            <span
              onClick={() => navigate(`${prev.route}`)}
              className="prev-btn fs-7"
            >
              {prev.title}
            </span>
          )}
