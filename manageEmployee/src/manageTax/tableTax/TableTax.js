    ...
    <div>
      ...
      <div className="staff-type-container">
        <div className="staffType-listing-title-container">
          <h4 className="staffType-listing-title">Table Tax Scale</h4>
        ...
        <div className="d-flex justify-content-center">
          <Col md={6}>
            ...
            <p className="mx-3 table-blue-warn">You must select regime</p>
            <p className="mx-3 table-blue-warn">
              You may want to activate the tax table usage for this institution
              first
            </p>
          </Col>
        </div>
        ...
        <div className="d-flex justify-content-center my-4">
          <button className="btn mx-2 light-blue-btn">
            Activate tax table (off)
          </button>

          <NavLink to="/dashboard/setup/hr/manage-tax/regime-list">
            <button className="btn mx-2 blue-btn">
              View tax table regime structures (Edit grade scales)
            </button>
          </NavLink>
        </div>
      </div>
