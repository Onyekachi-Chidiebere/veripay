...
import closeBtn from '../../images/redClose.svg';

const RegimeStructureList = () => {
  ...
  function editFormater(cell, row, index) {
    return (
      <p title="Edit">
        <NavLink to="/dashboard/setup/hr/manage-tax/edit-regime-structure">
          <svg
  ...
  return (
    <div>
      ...
      <div className="staff-type-container">
        ...
        {warn && (
          <div className="info-container d-flex px-3 justify-content-between mx-4 mb-4">
            <div>
...
export default RegimeStructureList;
