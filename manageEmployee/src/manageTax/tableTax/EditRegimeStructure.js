...
import BasicScaleAddTable from '../tableTax/basicScaleTable/BasicTable';
import SortCaret from '../../components/table/SortCaret';
import '../../styles/componentStyle.css';
import AddUnitTax from './AddUnitTax';
import useBasicScale from './useBasicScale';
import { useNavigate } from 'react-router-dom';
import warnIcon from '../../images/orangeWarn.svg';
import closeBtn from '../../images/orangeClose.svg';

const EditRegimeStructure = () => {
  ...
  return (
    <div>
      ...
      <h3 className="staff-type-title">Tax Table Scales</h3>
      {warn && (
        <div className="info-container-orange d-flex px-3 justify-content-between mx-4 mb-4">
          <div>
            <img className="m-2" src={warnIcon} />
      ...
      <div className="staff-type-container">
        <div className="staffType-listing-title-container">
          <h4 className="staffType-listing-title">Add/Update Salary Scales</h4>
        ...
        <div className="d-flex justify-content-center my-4">
          <button className="btn blue-btn">Save/Update</button>
        </div>
      </div>
    </div>
  );
};
export default EditRegimeStructure;
